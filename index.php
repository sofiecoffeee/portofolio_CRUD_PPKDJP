...
//Skills
$q_my_skills = mysqli_query($conn, "SELECT * FROM my_skills ORDER BY percentage DESC LIMIT 8 ");
$my_skills = mysqli_fetch_all($q_my_skills, MYSQLI_ASSOC);
...
//Blog Content
$q_blog_content = mysqli_query($conn, "SELECT * FROM blog_content ORDER BY id DESC LIMIT 3");
$blog_content = mysqli_fetch_all($q_blog_content, MYSQLI_ASSOC);
...
if (isset($_POST['save'])) {
    ...
    header("location:index.php?kirim=berhasil#contact-section");
}
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
                ...
                <div class="slider-item ">
                    ...
                    <div class="container">
                        <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
                            <div class="one-third js-fullheight order-md-last hero-image" style="background-image:url(admin/assets/img/<?php echo ($sliders) ? $value['image'] : '' ?>);">
                                <div class="overlay"></div>
                            </div>
            ...
            <div class="row d-flex">
                <div class="col-md-6 col-lg-5 d-flex">
                    <div class="img-about img d-flex align-items-stretch">
                        <div class="overlay"></div>
                        <div class="img d-flex align-self-stretch align-items-center" style="background-image:url(image_bank/foto-profile.jpg);">
                        </div>
                    </div>
                </div>
    ...
    <section class="ftco-section" id="services-section">
        <div class="container">
            ...
            <div class="row">
                <?php foreach ($service as $index => $value) {
                ?>
                    <div class="col-md-4 text-center d-flex ftco-animate">
                        <a href="#" class="services-1">
                            <span class="icon">
                                <i class="<?php echo $service ? $value['icon'] : '' ?>"></i>
                            </span>
                            <div class=" desc">
                                <h3 class="mb-5"><?php echo $service ? $value['service_name'] : '' ?></h3>
    ...
    <section class="ftco-section" id="skills-section">
        <div class="container">
            ...
            <div class="row">
                <?php foreach ($my_skills as $index => $value) {
                ?>

                    <div class="col-md-6 animate-box">
                        <div class="progress-wrap ftco-animate">
                            <h3><?php echo ($my_skills) ? $value['skills'] : '' ?></h3>
                            <div class="progress">
                                <div class="progress-bar color-6" role="progressbar"
                                    aria-valuenow="<?php echo $value['percentage']; ?>" aria-valuemin="0"
                                    aria-valuemax="100" style="width:<?= $value['percentage'] ?>%">
        ...
        <div class="container">
            <div class="row justify-content-center pb-5">
                <div class="col-md-12 heading-section text-center ftco-animate">
                    ...
                    <p>Here is my biggest project achievement</p>
                </div>
            </div>
            <div class="row">
                <?php
    ...
    <section class="ftco-section" id="blog-section">
        <div class="container">
            ...
            <div class="row">
                <?php foreach ($blog_content as $index => $value) { ?>

                    <div class="col-md-4 d-flex ftco-animate">
                        <div class="blog-entry justify-content-end">

                            <a href="https://medium.com/@sofiecoffe" class="block-20"
                                style="background-image: url(admin/assets/img//<?php echo ($blog_content) ? $value['image'] : '' ?>);">
                            </a>
                            ...
                            <div class="text mt-3 float-right d-block">
                                ...
                                <div class="d-flex align-items-center mb-3 meta">
                                    <p class="mb-0">
                                        <span class="mr-2"><?= date('F j, Y', strtotime($value['date'])) ?></span>
                                        <a href="#" class="mr-2"> <?php echo $value['uploader'] ?></a>
                                        <a href="#" class="meta-chat">
                                            <span class="icon-chat"></span><?php echo $value['comment_count'] ?>
                                        </a>
                                    </p>
                                </div>

                                <h3 class="heading">
                                    <a href="https://medium.com/@sofiecoffe">
        ...
        <div class="container">
            <div class="row justify-content-center mb-5 pb-3">
                <div class="col-md-7 heading-section text-center ftco-animate">
                    ...
                    <p>Lets connect and get some cups of coffee!</p>
                </div>
            </div>
            ...
            <div class="row d-flex contact-info mb-5">
                ...
                <div class="col-md-6 col-lg-3 d-flex ftco-animate">
                    <div class="align-self-stretch box p-4 text-center">
                        ...
                        <p><a href="tel://1234567920"><?php echo ($settings)['phone'] ?></a></p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 d-flex ftco-animate">
                    <div class="align-self-stretch box p-4 text-center">
                        ...
                        <p><a href="mailto:sofiecoffe@gmail.com"><?php echo ($settings)['email'] ?></a></p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 d-flex ftco-animate">
                    <div class="align-self-stretch box p-4 text-center">
                        ...
                        <p><a href="#"><?php echo ($settings)['website_name'] ?></a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="row no-gutters block-9">
                ...
                <div class="col-md-6 d-flex">
                    <div class="img" style="background-image: url(image_bank/contact_me.png);"></div>
                </div>
            </div>
        </div>
    </section>
